...
class WebProfileRedactionFormWidget extends StatelessWidget {
  const WebProfileRedactionFormWidget({Key? key}) : super(key: key);
...
class _SaveButtonWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final model = context.watch<ProfileRedactionModel>();
    final onPressed = model.canStartRegistration == true ? () {} : null;
